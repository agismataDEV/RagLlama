...
CONTAINS
    ...
    SUBROUTINE INTERP3D(LOCDATA, FDATA, LOCFINAL, FFINAL)
        ...
        ! ones = 1 ; ones(:,1) = (/-1,0,-1,0,-1,0,-1,0/); ones(:,2) = (/-1,-1,0,0,-1,-1,0,0/); ones(:,3) = (/-1,-1,-1,-1,0,0,0,0/)
        ! 1 -> 000, 2 -> 100, 3 -> 010, 4 -> 110, 5 -> 001,  6 -> 101, 7 -> 011, 8 -> 111
        c00 = FDATA(1, :)*(1 - x_d) + FDATA(2, :)*x_d
        c01 = FDATA(5, :)*(1 - x_d) + FDATA(6, :)*x_d
        c10 = FDATA(3, :)*(1 - x_d) + FDATA(4, :)*x_d
