            ...
            if (cModelParams.PrimarySourceType /= iEI_LOADFIELD) then
                ...
                if (cModelParams.ContrastSourceType == iCI_SCATTERER) then
                    ...
                    elseif (trim(ScattererParams%Distribution) == 'polydisperse') then
                        ...
                        errstatus = vdrnggamma(VSL_RNG_METHOD_GAMMA_GNORM_ACCURATE, STREAM2, INT(ScattererParams%N), ScattererParams%R0, 2.0D0, 0.0D0, 2.0D0)
                        ...
                        ! errstatus = vdrnggaussian( VSL_RNG_METHOD_GAUSSIAN_BOXMULLER, STREAM2, INT(ScattererParams%N), ScattererParams%R0, SUM(ScattererParams%PDRange)*1E6/2.0D0, 0.125D0 )
                        ! ScattererParams%R0 = ScattererParams%R0*1E-6;
                    end if
