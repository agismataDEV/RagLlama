...
%legendtitle Creates a more flexible legend
%
% legendtitle(M, param1, val1, ...)
% legendtitle(h, M, param1, val1, ...)
% [legend_h,object_h,plot_h,text_str] = legendtitle(...)
% 
...
% post-legendtitle and want to maintain repositioning of the legends,
...
%
%   In addition to these legendtitle-specific parameters, this function will
...
validatestring(Opt.bufferunit, {'pixels','normalized','inches','centimeters','points','characters'}, 'legendtitle', 'bufferunit');
validatestring(Opt.box, {'on', 'off'}, 'legendtitle', 'box');
...
if iscell(Opt.anchor)
    ...
    validateattributes(Opt.anchor, {'numeric'}, {'integer', '<=', 8}, 'legendtitle', 'anchor');
end
